        ...
        return (
            <View style={styles.container}>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    <IconChar size={GLOBAL.width*0.9} title="안방 온도" value={28.5} color="#04D6B2"/>
                    <RowGraph size={GLOBAL.width*0.9} title="안방의 미세먼지 지수" value1={29} maxValue={100} color="#04D6B2"/>
                </ScrollView>
                {this.leftMenu()}
            </View>
        );
