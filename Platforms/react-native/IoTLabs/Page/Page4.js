        ...
        return (
            <View style={styles.container}>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    <IconChar size={GLOBAL.width*0.9} title="외부1 온도" value={27.5} color="#2FA6D9"/>
                    <RowGraph size={GLOBAL.width*0.9} title="외부1 미세먼지 지수" value1={24} maxValue={100} color="#2FA6D9"/>
                </ScrollView>
                {this.leftMenu()}
            </View>
        );
